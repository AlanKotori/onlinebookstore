...
router.get('/code', cors(),function(req, res, next) {
    let transporter = nodemailer.createTransport({
        //  邮箱
        host: "smtp.office365.com",//这是用hotmail发送的
    ...
    let getcode_random = Math.floor(Math.random()*1000000000000 % 1000000);
    ...
    let mailOptions = {
     ...
     findcode.find({email:req.query.email},function(error,data){
        //  console.log(data[0]);
