...
router.post('/book', function(req, res) {
    ...
    bookpage.find({id},function(error,data){
        res.render('book', { data: data , title:id,userid:userid});
    })
...
router.get('/bookadd',function(req,res){
    res.render('bookadd', { title: '加入新内容' });
})
...
router.post('/update',function(req,res){
    // console.log(req.body);
    bookpage.remove({id:req.body.id},function(error,data){
